...
public class ProductRepoTest {
	...
	public void testFindAll() {
		List<Product> productList = Arrays.asList(new Product(1L, "Product1", 10.0), new Product(2L, "Product2", 20.0));
  ...
  verify(productRepo, times(1)).findById(productId); verify(productRepo,
  times(1)).save(existingProduct); assertEquals(updatedProduct, result); }
	...
	@Test 
	public void testFindProductsLessThanPrice() { // Mocking data 
		double  price = 100.0; Product product1 = new Product(1L, "Product1", 90.0); 
		Product  product2 = new Product(2L, "Product2", 110.0); List<Product> productList =
  ...
  assertThat(result.size()).isEqualTo(2); // Update this line // Add additional  assertions based on your data
